            ...
            <div class="tarjeta-prop p-4">
                ...
                <c:choose>
                    ...
                    <c:when test="${not empty caracteristicaEditar}">
                        ...
                        <form
                            method="post"
                            action="${pageContext.request.contextPath}/admin/caracteristicas">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a
                                    href="${pageContext.request.contextPath}/admin/caracteristicas"
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="d-flex
                                        ...
                                        <a
                                            href="${pageContext.request.contextPath}/admin/caracteristicas?id=${caracteristica.id}"
